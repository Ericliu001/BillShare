...
public class SelectMembersDialog extends DialogFragment implements
	...
	public void onAttach(Activity activity) {
		...
		try {
			...
			throw new ClassCastException(activity.toString()
					+ " must implement SelectBillsDialogListener");
		}
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// setRetainInstance(true); this will not work
	}
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
		...
		builder.setView(dialogView).setTitle(R.string.select_members)
	...
	public Loader<Cursor> onCreateLoader(int id, Bundle args) {
		...
		return new CursorLoader(getActivity(), BillProvider.DIALOG_MEMBER_URI,
